  ...
  <div class="modules">
    ...
    <div class="header">
      ...
      <div class="searchOrder">
        <input v-model="searchNum" v-focus="focusStatus" type="text" :placeholder="'请扫描单号'">
...
export default {
  ...
  methods: {
    getSNList() {
      // let _this = this
      // V.get('http://podevapp01.derucci.com:50100/RESTAdapter/SecurityCodePrint/PrdOrder', {
      //   AUFNR: '1000000743',
      //   ZIP: 'D01_LA1_B2404',
      //   ZBQXH: 20
      // }).then(function(data) {
      ...
      //   // _this.loadingShow(false)
      // })
      V.post('http://10.12.0.153:50100/RESTAdapter/securitycodeprint/prdorder', `{
          ITM: {
            AUFNR: '1000000743',
            ZIP: 'AA',
            ZBQXH: '20'
